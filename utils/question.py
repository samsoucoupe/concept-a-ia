...
if type_de_probleme=="river":
    ...
    boat="non" #Si c'est un sceau, il n'y a pas de bateau
boat_size=1
...
liste_element= {"element":{},"info_problem":{"type":type_de_probleme,"actions_possible":actions,"position_initial":[],"position_final":[],"boat_only":boat,"boat_size":boat_size,"regle_obligatoire":None,"regle_traverser": None}} #Création du dictionnaire
print(separateur)
