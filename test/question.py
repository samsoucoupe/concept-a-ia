...
pwd = os.path.join(actual_folder, "Rules")
...
if type_de_probleme == "river":
    liste_element['info_problem']['position_initial']=[int(elt) for elt in liste_element['info_problem']['position_initial']]+[1]
    liste_element['info_problem']['position_final']=[int(elt) for elt in liste_element['info_problem']['position_final']]+[0]
print(separateur)
...
if B_regles and  type_de_probleme == "river":
    ...
    print("Voulez-vous limiter le nombre de chaque élément qui se déplace sur le bateau ? (Exemple : 1 de chaque élément maximum) ")
