...
python3 générateur.py ; python3 generator_file_general.py -name sceau ;dot -Tpng sceau.dot -o sceau.png;java -cp talosExamples-0.4-SNAPSHOT-jar-with-dependencies.jar StateGraph -n 10 -print 0 -resultsType 1 -crossingRiver false -file sceau.xml
